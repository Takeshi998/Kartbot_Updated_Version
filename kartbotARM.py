    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            try: ## TESTE PRA NAO CAIR O BRIDGE TODA HORA
                ...
                with open(f"{config['server_folder_path']}log.txt", "r", encoding='utf-8', errors='ignore') as f:
                    ...
                    if last_log_line != 0:
                        for line in log[last_log_line:]:
                            if line.startswith("[HITFEED] "):
                                ...
                                embed.set_image(url="http://driftk7.ddns.net:83/" + mapid + "-kart.png")
            ...
            except Exception as e: ## TESTE PRA NAO CAIR O BRIDGE TODA HORA
                traceback.print_exc()
